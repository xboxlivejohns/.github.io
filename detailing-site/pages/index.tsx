...
export default function Home() {
  return (
    <>
      <NextSeo
        title="Detailing Site Baseline"
        description="Kickstart your car detailing experience with Next.js 14, Tailwind CSS, and SEO-ready defaults."
        openGraph={{
          title: "Detailing Site Baseline",
          description:
      ...
      />
      <section className="relative isolate overflow-hidden rounded-3xl bg-paper px-6 py-12 shadow-sm">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="mt-6 font-bold">Detailing Site Baseline</h1>
